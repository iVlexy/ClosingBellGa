...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, MatButtonModule, MatIconModule,
    ...
    MatSnackBarModule, MatChipsModule, MatTooltipModule, MatSlideToggleModule, MatCardModule],
  template: `
<div class="page-container">
  <div class="page-header">
    <div>
      <h1 class="page-title">Email Templates</h1>
      <p class="page-sub">Pre-written follow-up messages for each stage of the process</p>
    </div>
  ...
  <div *ngFor="let stage of stagesWithTemplates()">
    ...
    <div class="card-grid">
      <mat-card *ngFor="let t of stage.templates" class="tmpl-card" [class.inactive]="!t.isActive">
        ...
        <mat-card-actions>
          <button mat-button (click)="copyText(t.subject + '\n\n' + t.body)" matTooltip="Copy full template">
            <mat-icon>content_copy</mat-icon> Copy
          </button>
          <button mat-button (click)="openForm(t)"><mat-icon>edit</mat-icon> Edit</button>
          <button mat-button color="warn" (click)="delete(t)"><mat-icon>delete</mat-icon></button>
...
<ng-template #formDialog>
  ...
  <mat-dialog-content [formGroup]="form">
    ...
    <mat-form-field appearance="outline" class="full">
      ...
      <mat-hint>Use [ClientName], [Address], [Date] as placeholders</mat-hint>
    </mat-form-field>
...
export class EmailTemplatesComponent implements OnInit {
  ...
  copyText(text: string) {
    navigator.clipboard.writeText(text).then(() => this.snack.open('Copied to clipboard', 'OK', { duration: 2000 }));
  }
}
