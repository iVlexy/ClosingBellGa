    ...
    private void ComposeForm(IContainer container)
    {
        container.Column(col =>
        {
            ...
            col.Item().PaddingTop(16).Background("#FFF8E1").Padding(12).Column(c =>
            {
                ...
                c.Item().PaddingTop(4).DefaultTextStyle(x => x.FontSize(8).FontColor("#888888")).Text($"Generated by Lookin' Lively Exterior Solutions on {DateTime.UtcNow:MMMM d, yyyy}");
            });
        });
    }
